...
Public Class SAPWBSPI
    ...
    Public Function SetStatus(pData As TSAP_WbsStatusData, Optional pOKMsg As String = "OK") As String
        SetStatus = ""
        Try
            oRfcFunction = destination.Repository.CreateFunction("BAPI_BUS2054_SET_STATUS")
            RfcSessionManager.BeginContext(destination)
    ...
    Public Function GetStatus(pData As TSAP_WbsStatusData, Optional pOKMsg As String = "OK") As String
        GetStatus = ""
        Try
            oRfcFunction = destination.Repository.CreateFunction("BAPI_BUS2054_GET_STATUS")
            RfcSessionManager.BeginContext(destination)
