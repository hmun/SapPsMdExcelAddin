...
Public Class TSAP_ProjectStatusData
    ...
    Public Sub New(ByRef pPar As SAPCommon.TStr, ByRef pIntPar As SAPCommon.TStr, ByRef pSAPProjectDefinitionPI As SAPProjectDefinitionPI, pFunction As String)
        aPar = pPar
        aIntPar = pIntPar
        aFunction = pFunction
        ...
        If pFunction = "GetStatus" Then
            pSAPProjectDefinitionPI.getMeta_GetStatus(aParamDic, aStrucDic)
        ElseIf pFunction = "SetStatus" Then
            pSAPProjectDefinitionPI.getMeta_SetStatus(aParamDic, aStrucDic)
        End If
    End Sub
