...
Public Class SapGeneral
    Const cVersion As String = "1.0.0.1"
    Const cAssemblyName As String = "SapCoMdExcelAddin"
    ...
    Public Function checkVersion() As Integer
        ...
        Catch Exc As System.Exception
            MsgBox("No SAP-Con Sheet in current workbook. Check if the current workbook is a valid SAP CO Md Template",
