...
Partial Public NotInheritable Class SapPsMdExcelAddin
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _SapPsMdExcelAddin As SapPsMdExcelAddin
    ...
    Friend Shared Property SapPsMdExcelAddin() As SapPsMdExcelAddin
        Get
            Return _SapPsMdExcelAddin
        End Get
        Set
            If (_SapPsMdExcelAddin Is Nothing) Then
                _SapPsMdExcelAddin = value
            Else
